...
const SEARCH_INDEX = [
  ...
  { type:'troubleshooting', title:'Latency & Timing', subtitle:'Troubleshooting', url:'/troubleshooting/latency', aliases:['latency','timing','fix latency','52','60','sendingtme','transacttime','sendingtime','122','origsendingtime','slow acknowledgement','slow ack','timestamp mismatch','clock drift','ntp','ptp','round-trip time','round trip','rtt','clock skew','timestamp'] },
  { type:'troubleshooting', title:'Duplicate Orders', subtitle:'Troubleshooting', url:'/troubleshooting/duplicate-orders', aliases:['duplicate order','duplicate orders','duplicate clordid','same order twice','posdup','possdupflag','43=y','origsendingtime','122','duplicate new order single','repeated order','resend duplicate','resend order','double order','duplicate submission'] },
